 ...
 *         Если Isenbaev не встретился, мы не можем определить числа Исенбаева
 ...
 *     В distances ключом является число Исенбаева (дистанция), значением - фамилия участника,
 *     в participants  - наоборот, ключ - фамилия, значение - дистанция до Исенбаева.
 ...
 *		 от Исенбаева currentDistance, начальное значение - 0.
 *     Идея: у Исенбаева дистанция 0, находим все кманды, где он играл, присваиваем участникам дистанцию 1,
 *           убираем из списка команд те, где встретился Исенбаев,
 ...
 *     distances[currentDistance], имеющих одинаковое текущее число Исенбаева.
 *     Начинаем с 0, т.е. с Исенбаева, если он упоминался в списках команд.
 ...
 *                       дистанцию на 1 больше, т.е. заносим в словарь distances с ключом currentDistance + 1
 *               5.1.1.2 удаляем текущую команду из общего списка (std::list позволяет это делать "дёшево"),
 ...
 *    Для этого пробегаем по словарю distances по значениям числа Исенбаева
 *    7.1 Пробегаем по множеству участников с данным числом Исенбаева,
 *        заносим в словарь participants с ключом 'фамилия' - member и значением дистанции
